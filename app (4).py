...
<style>
    ...
    .search-card .stButton > button:hover {{
        background: #333 !important;
    }}
    .search-card .stButton > button:active {{
        transform: scale(0.97) !important;
    }}
    /* Убираем лишние отступы у колонок внутри карточки */
    .search-card [data-testid="column"] {{
        padding: 0 !important;
    }}
    .search-card [data-testid="stVerticalBlock"] > div {{
        gap: 0 !important;
    }}
</style>
