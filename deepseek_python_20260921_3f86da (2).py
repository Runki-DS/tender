    ...
    try:
        ...
        try:
            ...
            if r.status_code == 200 and r.json():
                ...
                # Основной путь: staffNumber -> {data: N, isActual: bool}
                ...
                # Fallback: historyStaffNumbers -> {data: [{date, staffNumber}, ...]}
        ...
        # 4. /api3/briefReport — Булевы флаги жёлтой/красной информации
        ...
        # 5. /api3/scoring — Сумма rating по трём целевым моделям из scoringData
        try:
